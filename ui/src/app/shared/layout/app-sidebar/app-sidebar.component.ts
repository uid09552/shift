...
export class AppSidebarComponent {
  ...
  navItems: NavItem[] = [
    ...
    },
    {
      ...
      subItems: [
        { name: "User Profiles", path: "/user-profiles", pro: false },
        { name: "Shifts", path: "/shifts", pro: false },
        { name: "Workstations", path: "/workstations", pro: false },
        { name: "Capabilities", path: "/capabilities", pro: false },
        { name: "Planner Settings", path: "/planner-settings", pro: false }
      ],
    },
    {
      name: "Planner",
      ...
      subItems: [
        { name: "Schedule", path: "/kalender", pro: false },
